...
namespace OpenFlightVRC.Extensions
{
	public static class DrawArrow
	{
		...
		{
			ForGizmo(pos, direction, UnityEngine.Gizmos.color, arrowHeadLength, arrowHeadAngle, arrowPosition);
		}
		...
		{
			ForGizmoTwoPoints(from, to, UnityEngine.Gizmos.color, arrowHeadLength, arrowHeadAngle, arrowPosition);
		}
		...
		)
		{
			...
			{
				UnityEngine.Gizmos.color = color;
				UnityEngine.Gizmos.DrawRay(arrowTip, right);
				UnityEngine.Gizmos.DrawRay(arrowTip, left);
				UnityEngine.Gizmos.DrawRay(arrowTip, up);
				UnityEngine.Gizmos.DrawRay(arrowTip, down);
			}
			else
			{
